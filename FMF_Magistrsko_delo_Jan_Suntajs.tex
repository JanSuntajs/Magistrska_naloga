...
\begin{equation}\ket{\psi(0)}=\sum\limits_\alpha A_\alpha \ket{\alpha}, \hspace{5mm} \hat{H}\ket{\alpha}=E_\alpha\ket{\alpha}.
\end{equation}
...
\subsection{Termalizacija in hipoteza termalizacije lastnih stanj}
